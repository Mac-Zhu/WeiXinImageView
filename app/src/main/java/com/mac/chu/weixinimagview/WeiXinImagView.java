 ...
 * .
 */
public class WeiXinImagView extends AppCompatImageView {
    ...
    private final int mBgColor = Color.TRANSPARENT;
    private int mBgAlpha = 0;
    private Paint mPaint;


    public WeiXinImagView(Context context) {
        super(context);
        init();
    }

    public WeiXinImagView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public WeiXinImagView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            mScaleCenter.set(detector.getFocusX(), detector.getFocusY());
    ...
    private Runnable mClickRunnable = new Runnable() {
        ...
        public void run() {
            if (mClickListener != null) {
                mClickListener.onClick(WeiXinImagView.this);
            }
        }
    };
    ...
    private GestureDetector.OnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            if (mLongClick != null) {
                mLongClick.onLongClick(WeiXinImagView.this);
            }
        }
